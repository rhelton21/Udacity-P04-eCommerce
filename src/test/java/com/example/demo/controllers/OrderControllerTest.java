...
public class OrderControllerTest {
    ...
    @Test
    public void test_submitNoUsername() {
    ...
    public void test_getOrders() {
        List<UserOrder> userOrders = test_createOrderHistory(user);
    ...
    @Test
    public void test_getOrdersNoUsername() {
        final ResponseEntity<List<UserOrder>> response = orderController.getOrdersForUser("wrong");
        assertNotNull(response);
        assertEquals(404, response.getStatusCodeValue());
    }

    private List<UserOrder> test_createOrderHistory(User user) {
